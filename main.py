...
class Simulation(tk.Canvas):
    def __init__(self, parent):
        ...
        self.bind("<KeyPress-d>", lambda event : self.boat.rotate(True))
        self.bind("<KeyPress-q>", lambda event : self.boat.rotate(False))
        ...
        self.bind("<KeyPress-Right>", lambda event :  self.boat.trim(True))
        self.bind("<KeyPress-Left>", lambda event :  self.boat.trim(False))

        self.bind("<Any-KeyRelease>",self.onRelease)
